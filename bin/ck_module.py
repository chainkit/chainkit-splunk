...
import input_module_ck_module as input_module
...
'''
    ...
    Add your modular input logic to file input_module_ck_module.py
'''
class ModInputck_module(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputck_module, self).__init__("ta_chainkit", "ck_module", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputck_module, self).get_scheme()
        scheme.title = ("ck_module")
...
if __name__ == "__main__":
    exitcode = ModInputck_module().run(sys.argv)
    sys.exit(exitcode)
